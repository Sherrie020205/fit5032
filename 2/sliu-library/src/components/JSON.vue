    ...
    <section class="lab-section">
      ...
      <ul>
        <li
          ...
          :style="author.name === 'George Orwell' ? { fontWeight: 'bold', color: '#fff', backgroundColor: '#42b883' } : {}"
        >
    ...
    <section class="lab-section">
      ...
      <ul>
        <li
          ...
          :key="author.id"
          :class="{ highlight: author.name === 'George Orwell' }"
          :style="author.name === 'George Orwell' ? { fontWeight: 'bold', color: '#fff', backgroundColor: 'green' } : {}"
        >
          {{ author.name }} ({{ author.birthYear }})
        </li>
      </ul>
